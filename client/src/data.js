// Software Engineer Portfolio Data
// Accurately populated from Ahsan Mehmood's Resume
...
export const services = [
  {
    ...
    deliverables: [
      ...
      'Selenium & Playwright Web E2E Suites',
      'TestNG & Cucumber BDD (POM Pattern)',
      '85%+ Automated Test Coverage Gates'
    ],
  ...
  },
  {
    ...
    deliverables: [
      ...
      'JSON/XML Schema & Data Integrity Validation',
      'Performance & Load Testing (JMeter, Gatling)',
      'SQL Query Verification across MySQL/PostgreSQL'
    ],
  ...
  },
  {
    ...
    deliverables: [
      ...
      'Node.js REST API & Microservice Backend',
      'MySQL / PostgreSQL Database Optimization',
      'CI/CD Pipelines & Clean Architecture'
    ],
...
export const experiences = [
  {
    ...
    highlights: [
      ...
      'Developed data extraction automation scripts in Python and Java to pull mobile app data into Excel/CSV reports for business analysis and QA dashboards.',
      'Applied SQL queries to validate data accuracy between frontend, APIs, and backend databases during integration testing cycles.'
    ]
  },
  {
    id: 2,
    ...
    highlights: [
      ...
      'Wrote SQL queries for data validation, backend testing, and integration verification across MySQL databases.'
    ]
  },
  {
    id: 3,
    ...
    highlights: [
      ...
      'Authored comprehensive QA documentation: test plans, test cases, execution reports, defect logs, and release sign-off summaries.'
    ]
  }
];
